...
# Repo-relative; override the data location with the FRP_DATA_DIR env var.
# Reads per-event ``{event}_hourly.csv`` files (the hourly tables produced by the
# event-onboarding step, which is NOT shipped — see data/README.md).
